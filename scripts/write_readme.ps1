# scripts/write_readme.ps1
# Writes the new README.md content. Run once after pulling the docs branch.
...
6. **Glassy, gradient, day/night-aware UI.**
...
8. **Single source of truth for notifications.**
...
$target = 'd:\Documents\MyWeather\aakaash\README.md'
